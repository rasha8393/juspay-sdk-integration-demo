...
--data-urlencode 'metadata.multiWebhookUrlConfigs=[{"webhookUrl":"https://webhook.site/ddd99ab4-ec18-42cb-b24d-d5df0c441dbd","enabledEvents":["ORDER_CREATED","TXN_CREATED","TXN_UPDATED","SF_EPG_TXN_ID","ORDER_UPDATED","ORDER_SUCCESS"],"customHeaders":{"header a":"value a","header b":"value b"}}]'
